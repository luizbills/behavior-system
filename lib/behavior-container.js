...
BehaviorContainer.prototype = {
  ...
  remove (key) {
    ...
    this._pausedList[key] = NULL
    this._infoList[key] = NULL
  ...
  has (key) {
    return this._infoList[key] !== NULL
  },
  ...
  isPaused (key) {
    return this._pausedList[key] !== NULL
  },
    ...
    if (method !== NULL) {
      switch(args.length) {
        ...
        case 3:
          ...
          break
        default:
          result = method.apply(NULL, [entity, options, ...args])
          break
      }
    }
